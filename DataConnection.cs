...
namespace InventoryAPP
{
    public class DataConnection
    {
        ...
        //execute query with parameters and return no of rows affected
        ...
        // Execute query and return first row of first column
        ...
        //Retrives the number of rows available in the given table
        ...
        // Retrives the record from database and returns the rows affescted by passing a set of values --
                ...
                if (values != null)
                {
                    foreach (string key in values.Keys)
                    {
                        ...
                        else
                        {
                            ...
                            SqlParameter tvparam = cmd.Parameters.AddWithValue("@ProgramNameList", values[key]);
        ...
        public void BulkCopy(DataTable Exceldt, string table, Dictionary<string, string> columns)
        {
            ...
            try
            {
                ...
                {
                    objbulk.ColumnMappings.Add(col, columns[col]);
                }
            ...
            catch (Exception ex)
            {
                //  throw ex;
                con.Close();
                // insert_sqlerror("BulkCopy", ex.ToString());
        ...
        public DataTable GetTablewithvalues(string command, Dictionary<string, Object> values = null)
        {
            cmd.CommandText = command;
            if (values != null)
                foreach (string s in values.Keys)
